...
const articles: ArticleSeed[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    title: 'Panduan Lengkap Alat Uji Kualitas Air untuk Laboratorium & Industri: Jenis, Fungsi, dan Rekomendasi Terbaik 2026',
    excerpt:
...
**Hubungi tim AndisLab sekarang** untuk konsultasi teknis gratis, demo produk, atau permintaan penawaran harga (RFQ) alat uji kualitas air sesuai kebutuhan spesifik Anda!
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    title: 'Panduan Autoclave Laboratorium: Prinsip Sterilisasi Uap, Jenis, Validasi, dan Cara Memilih Autoclave Terbaik',
    excerpt:
...
**Hubungi tim AndisLab** untuk konsultasi teknis gratis, kunjungan demo, atau permintaan penawaran harga (RFQ) autoclave yang sesuai dengan kebutuhan dan anggaran Anda!
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    title: 'Panduan Desain & Furniture Laboratorium Modern: Meja Lab, Fume Hood, Wet Scrubber, dan Standar Keselamatan',
    excerpt:
    ...
    image: 'https://images.unsplash.com/photo-1582719508461-905c673771fd?auto=format&fit=crop&q=80&w=1200&h=630',
...
**Hubungi tim AndisLab** untuk survei lokasi gratis, konsultasi desain, dan penawaran harga komprehensif untuk proyek pembangunan laboratorium Anda!
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    title: 'Panduan Cold Chain & Penyimpanan Sampel Laboratorium: Ultra Low Freezer, Kulkas Vaksin, dan Manajemen Rantai Dingin',
    excerpt:
...
**Hubungi tim AndisLab** untuk konsultasi cold chain, demo produk, atau permintaan penawaran harga (RFQ) peralatan cold storage sesuai kebutuhan laboratorium Anda!
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    title: 'Panduan Peralatan Dasar Laboratorium: Micropipette, Timbangan Analitik, Glassware, Shaker, dan Vortex Mixer',
    excerpt:
      'Kenali peralatan dasar yang wajib dimiliki setiap laboratorium — dari micropipette presisi tinggi, timbangan analitik, glassware borosilikat, hingga shaker dan vortex mixer. Panduan lengkap spesifikasi, cara penggunaan, dan rekomendasi produk terbaik.',
