        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            <Link href="/" className="flex items-center gap-2.5 mb-6 group">
              <Image src="/logo.png" alt="AndisLab Logo" width={160} height={56} className="h-12 md:h-14 w-auto object-contain bg-white/10 rounded-xl p-2 transition-transform hover:scale-105" />
            </Link>
