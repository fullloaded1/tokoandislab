...
import { Beaker, Thermometer, FlaskConical, Droplets, Microscope, Search, TestTube, Scale } from "lucide-react";
...
const categories = [
  ...
  { id: "other", label: "Lainnya", icon: Search, color: "bg-slate-100 text-slate-600" },
];
