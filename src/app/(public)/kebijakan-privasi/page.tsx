/* Hallmark · page: KebijakanPrivasi · genre: modern-minimal · macrostructure: Long Document · design-system: design.md */
import { Metadata } from "next";

export const metadata: Metadata = {
  title: "Kebijakan Privasi — AndisLab",
  description: "Pelajari bagaimana AndisLab mengumpulkan, menggunakan, dan melindungi data pribadi Anda. Informasi privasi lengkap untuk pelanggan dan pengguna website.",
