...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticUrls: MetadataRoute.Sitemap = [
    ...
    {
      url: `${BASE_URL}/solusi/pendidikan`,
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/solusi/pengolahan-air`,
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/promo-merdeka`,
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.7,
    },
    ...
    {
      url: `${BASE_URL}/wilayah/semarang`,
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/wilayah/makassar`,
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/wilayah/yogyakarta`,
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/wilayah/tangerang`,
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/daihan-labtech`,
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.8,
    },
